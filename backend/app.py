import os
import certifi  # Solving pymongo local issure certificate error
...
# Load local environment varibles
load_dotenv()
...
# Create client to connect with mongodb
client = motor.motor_asyncio.AsyncIOMotorClient(
    os.environ["MONGODB_URL"], tlsCAFile=certifi.where()
)

# Connection to the databse. Chenge the string for database name.
db = client.get_database("farmstack")

# Connection the the collection(table)
